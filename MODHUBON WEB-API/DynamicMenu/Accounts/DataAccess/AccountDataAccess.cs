...
namespace DynamicMenu.Accounts.DataAccess
{
    public class AccountDataAccess
    {
        ...
        public string SAVE_MULTIPLE_VOUCHER_GL_MTRANS(AccountInterface ob)
        {
            string s = "";
            SqlTransaction tran = null;
            try
            { //  (" INSERT INTO GL_MTRANS(TRANSTP, TRANSDT, TRANSMY, TRANSNO, SERIALNO, TRANSFOR, COSTPID, TRANSMODE, DEBITCD, CREDITCD, CHEQUENO, CHEQUEDT, AMOUNT, " +
              //                             " REMARKS, USERPC, USERID, INTIME, IPADDRESS) " +  //txtVouchNo.Text
              //                             " VALUES ('" + ddlTransType.Text + "','" + trDT + "','" + txtTransYear.Text + "'," + lblVCount.Text + "," + sl + ",'" + ddlTransfor.Text + "', " +
              ...
              //                             " '" + cqdt + "','" + txtAmount.Text + "','" + txtRemarks.Text + "','" + PCName + "','" + userName + "', @INTIME, '" + ipAddress + "')");
                ...
                tran = con.BeginTransaction();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "INSERT INTO GL_MTRANS (TRANSTP,TRANSDT,TRANSMY,TRANSNO,SERIALNO,TRANSFOR,COSTPID,TRANSMODE,DEBITCD,CREDITCD,CHEQUENO,CHEQUEDT,AMOUNT,REMARKS,USERPC,USERID,INTIME,IPADDRESS) " +
                ...
                cmd.Parameters.Add("@SERIALNO", SqlDbType.BigInt).Value = ob.SERIALNO;
                cmd.Parameters.Add("@TRANSFOR", SqlDbType.NVarChar).Value = ob.Transfor;
                cmd.Parameters.Add("@COSTPID", SqlDbType.NVarChar).Value = ob.Costpid;
                cmd.Parameters.Add("@TRANSMODE", SqlDbType.NVarChar).Value = ob.TRANSMODE;
                cmd.Parameters.Add("@DEBITCD", SqlDbType.NVarChar).Value = ob.DEBITCD;
        ...
        public string SAVE_MULTIPLE_VOUCHER_GL_MTRANSMST(AccountInterface ob)
        {
            string s = "";
            SqlTransaction tran = null;
            try
            {
                ...
                tran = con.BeginTransaction();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "INSERT INTO GL_MTRANSMST (TRANSTP,TRANSDT,TRANSMY,TRANSNO,USERPC, USERID,INTIME,IPADDRESS) " +
                     " VALUES (@TRANSTP,@TRANSDT,@TRANSMY,@TRANSNO,@USERPC,@USERID,@INTIME,@IPADDRESS)";
                cmd.Parameters.Clear();
                cmd.Parameters.Add("@TRANSTP", SqlDbType.NVarChar).Value = ob.Transtp;
                cmd.Parameters.Add("@TRANSDT", SqlDbType.Date).Value = ob.Transdt;
                cmd.Parameters.Add("@TRANSMY", SqlDbType.NVarChar).Value = ob.Monyear;
        ...
        public string doProcess_SALE_LtCost(AccountInterface ob)
        {
            string s = "";
            SqlTransaction tran = null;
        ...
        public string RcvChequeInsert(AccountInterface eim)
        {
            string s = "";
            SqlTransaction tran = null;
            try
            {
                ...
                cmd.CommandText = "INSERT INTO GL_CHEQUE(TRANSTP ,TRANSDT, TRANSMY, TRANSNO, TRANSMODE, DEBITCD, CREDITCD, CHEQUENO, CHEQUEDT, CHQBANKBR, AMOUNT, REMARKS ,STATUS, USERPC,USERID,INTIME,IPADDRESS)" +
                    "values(@TRANSTP ,@TRANSDT, @TRANSMY, @TRANSNO, @TRANSMODE, @DEBITCD, @CREDITCD, @CHEQUENO, @CHEQUEDT, @CHQBANKBR, @AMOUNT, @REMARKS ,@STATUS ,@USERPC,@USERID,@INTIME,@IPADDRESS)";

                cmd.Parameters.Clear();

                cmd.Parameters.Add("@TRANSTP", SqlDbType.NVarChar).Value = eim.Transtp;
                cmd.Parameters.Add("@TRANSDT", SqlDbType.SmallDateTime).Value = eim.Transdt;
                cmd.Parameters.Add("@TRANSNO", SqlDbType.NVarChar).Value = eim.TransNo;
                cmd.Parameters.Add("@TRANSMY", SqlDbType.NVarChar).Value = eim.Monyear;
                cmd.Parameters.Add("@TRANSMODE", SqlDbType.NVarChar).Value = eim.Transmode;
                cmd.Parameters.Add("@DEBITCD", SqlDbType.NVarChar).Value = eim.Debitcd;
                cmd.Parameters.Add("@CREDITCD", SqlDbType.NVarChar).Value = eim.Creditcd;
                cmd.Parameters.Add("@CHEQUENO", SqlDbType.NVarChar).Value = eim.Chequeno;
                cmd.Parameters.Add("@CHEQUEDT", SqlDbType.SmallDateTime).Value = eim.Chequedt;
                cmd.Parameters.Add("@CHQBANKBR", SqlDbType.NVarChar).Value = eim.ChequeBankbr;
                cmd.Parameters.Add("@AMOUNT", SqlDbType.NVarChar).Value = eim.Amount;
                cmd.Parameters.Add("@REMARKS", SqlDbType.NVarChar).Value = eim.Remarks;
                cmd.Parameters.Add("@STATUS", SqlDbType.NVarChar).Value = eim.Status;

                cmd.Parameters.Add("@USERPC", SqlDbType.NVarChar).Value = eim.Userpc;
                cmd.Parameters.Add("@USERID", SqlDbType.NVarChar).Value = eim.Userid;
        ...
        internal string RemoveExpParty(AccountInterface eim)
        {
            string s = "";
            SqlTransaction tran = null;
            try
            {
                ...
                tran = con.BeginTransaction();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "DELETE FROM GL_CHEQUE WHERE TRANSNO =@TRANSNO AND TRANSMY=@TRANSMY AND TRANSTP=@TRANSTP AND DEBITCD=@DEBITCD";
                cmd.Parameters.Clear();
        ...
        internal string RcvChequeUpdate(AccountInterface eim)
        {
            string s = "";
            SqlTransaction tran = null;
            try
            {
                ...
                tran = con.BeginTransaction();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update GL_CHEQUE set TRANSTP=@TRANSTP, TRANSDT=@TRANSDT,TRANSMY=@TRANSMY,TRANSMODE=@TRANSMODE, DEBITCD=@DEBITCD," +
                                  "CREDITCD=@CREDITCD,CHEQUENO = @CHEQUENO, CHEQUEDT = @CHEQUEDT,CHQBANKBR = @CHQBANKBR,AMOUNT = @AMOUNT, REMARKS = @REMARKS,STATUS= @STATUS" +
        ...
        public string IssChequeInsert(AccountInterface eim)
        {
            string s = "";
            SqlTransaction tran = null;
            try
        ...
        internal string RemoveChequeIss(AccountInterface eim)
        {
            string s = "";
            SqlTransaction tran = null;
            try
            {
                ...
                tran = con.BeginTransaction();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "DELETE FROM GL_CHEQUE WHERE TRANSNO =@TRANSNO AND TRANSMY=@TRANSMY AND TRANSTP=@TRANSTP AND CREDITCD=@CREDITCD";
                cmd.Parameters.Clear();
        ...
        internal string IssChequeUpdate(AccountInterface eim)
        {
            string s = "";
            SqlTransaction tran = null;
            try
        ...
        public string gl_Cheque_Process_MREC(AccountInterface ob)
        {
            string s = "";
            SqlTransaction tran = null;
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT INTO GL_MASTER ( TRANSTP, TRANSDT, TRANSMY, TRANSNO, SERIALNO, TRANSDRCR, TRANSFOR, COSTPID, TRANSMODE, DEBITCD, CREDITCD, DEBITAMT, CREDITAMT, " +
                                  " CHEQUENO, CHEQUEDT, REMARKS, TABLEID, USERPC, USERID, ACTDTI, IPADDRESS) " +
                                  " Values (@TRANSTP, @TRANSDT, @TRANSMY, @TRANSNO, @SERIALNO,'DEBIT', '', '', @TRANSMODE, @DEBITCD, @CREDITCD,@AMOUNT,0, @CHEQUENO, @CHEQUEDT, @REMARKS,'GL_CHEQUE', " +
                                  " @USERPC,@USERID, @ACTDTI, @IPADDRESS)";
                cmd.Parameters.Clear();
                ...
                cmd.CommandText = "INSERT INTO GL_MASTER ( TRANSTP, TRANSDT, TRANSMY, TRANSNO, SERIALNO, TRANSDRCR, TRANSFOR, COSTPID, TRANSMODE, DEBITCD, CREDITCD, DEBITAMT, CREDITAMT, " +
                                  " CHEQUENO, CHEQUEDT, REMARKS, TABLEID, USERPC, USERID, ACTDTI, IPADDRESS) " +
                                  " Values (@TRANSTP, @TRANSDT, @TRANSMY, @TRANSNO, @SERIALNO,'CREDIT', '','', @TRANSMODE,@CREDITCD, @DEBITCD,0,@AMOUNT, @CHEQUENO, @CHEQUEDT, @REMARKS,'GL_CHEQUE', " +
                                  " @USERPC,@USERID, @ACTDTI, @IPADDRESS)";
                cmd.Parameters.Clear();
                cmd.Parameters.Add("@TRANSTP", SqlDbType.NVarChar).Value = ob.Transtp;
                cmd.Parameters.Add("@TRANSDT", SqlDbType.DateTime).Value = ob.Transdt;
