    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <%  
                ...
                string accountnm = Request.QueryString["AccNM"];
                string accountcd = Request.QueryString["AccCode"];
                string date = Request.QueryString["From"];
                                    ...
                                    <table style="width: 100%" class="table table-hover">
                                        ...
                                        <%
                                            SqlCommand cmd2 = new SqlCommand(@"SELECT A.TRANSNO, REPLACE(CONVERT(VARCHAR(11),TRANSDT,106), ' ','-') TRANSDT, TRANSTP, 
                                                ...
                                                WHEN A.TABLEID NOT IN ('GL_STRANS','GL_MTRANS') THEN
