...
{
    public partial class ChequeReceiveInfoVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblrcvfrm.Text = Session["lblCreditNM"].ToString();
          ...
          //  lblAmount.Text = Session["lblAmount"].ToString();
            ...
            //   lblRemarks.Text=
            lblrcvto.Text = Session["banknm"].ToString();
            ...
            dbFunctions.lblAdd(@"select USERNM FROM GL_CHEQUE INNER JOIN ASL_USERCO ON GL_CHEQUE.USERID = ASL_USERCO.USERID where TRANSDT ='" + TrDate + "' and TRANSNO=" + vno + " ", lblUserName);
