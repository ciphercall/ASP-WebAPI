                ...
                <div id="contentBox">
                    ...
                    <div class="form-class">
                        ...
                        <div class="row form-class">
                            ...
                            <asp:Label ID="lblTransNO" runat="server" Style="display: none"></asp:Label>
                            <asp:Label ID="lblTransSSL" runat="server" Style="display: none"></asp:Label>
                            <asp:TextBox ID="lblMY" runat="server" Style="display: none"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Transaction Mode">
                                        ...
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="ddlTransModeEdit" runat="server" Font-Names="Calibri" CssClass="form-control input-sm"
                                                ...
                                                <asp:ListItem>LC DEPOSIT</asp:ListItem>
                                                <asp:ListItem>BANK DIRECT ADJ.</asp:ListItem>
