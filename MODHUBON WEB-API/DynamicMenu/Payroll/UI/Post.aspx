<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="Post.aspx.cs" Inherits="DynamicMenu.Payroll.UI.Post" %>
        ...
        <div id="contentBox">
            <div id="contentHeaderBox">
                ...
                <div class="btn-group pull-right" id="editOption">
                    ...
                    <ul class="dropdown-menu pull-right" style="" role="menu">
                        <% if (UserPermissionChecker.checkParmit("/Payroll/UI/Post.aspx", "INSERTR") == true)
                           { %>
                        <li><a href="#"><i class="fa fa-plus"></i>Create</a>
                        </li>
                        <% } %>
                        <% if (UserPermissionChecker.checkParmit("/Payroll/UI/Post.aspx", "UPDATER") == true)
                           { %>
                        <li><a href="#"><i class="fa fa-edit"></i>Update</a>
                        </li>
                        <% } %>
                        <% if (UserPermissionChecker.checkParmit("/Payroll/UI/Post.aspx", "DELETER") == true)
                           { %>
            ...
            <div class="form-class">
                ...
                <div class="table table-responsive table-hover" style="border: 1px solid #ddd; border-radius: 5px;">
                    <asp:GridView ID="gv_post" runat="server" BackColor="White" BorderStyle="None" CssClass="Gridview text-center" CellPadding="3"
                        CellSpacing="1" GridLines="Both" AutoGenerateColumns="False" ShowFooter="True" Font-Italic="False" Width="100%"
                        OnRowCommand="gv_post_RowCommand" OnRowDataBound="gv_post_RowDataBound"
                        OnRowCancelingEdit="gv_post_RowCancelingEdit" OnRowDeleting="gv_post_RowDeleting"
                        OnRowEditing="gv_post_RowEditing" OnRowUpdating="gv_post_RowUpdating">
                        <Columns>
                            <asp:TemplateField HeaderText="ID">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="txtItemCD" ReadOnly="true" runat="server" Width="98%" CssClass="form-control input-sm" />
                                </FooterTemplate>
                                <HeaderStyle Width="6%" />
                            ...
                            <asp:TemplateField HeaderText="Post Name">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtPOSTNMEdit" runat="server" TabIndex="10" CssClass="form-control input-sm" Text='<%# Eval("POSTNM") %>' Width="100%"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblPOSTNM" runat="server" Text='<%# Eval("POSTNM") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtPOSTNMFooter" TabIndex="1" runat="server" CssClass="form-control input-sm" Width="100%"></asp:TextBox>
                                </FooterTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <% if (UserPermissionChecker.checkParmit("/Payroll/UI/Post.aspx", "DELETER") == true)
                                       { %>
                                    <asp:ImageButton ID="imgbtnPEdit" runat="server" CommandName="Edit" Height="20px" ImageUrl="~/Images/Edit.png" TabIndex="15" ToolTip="Edit" Width="20px" />
                                    <% } %>
                                    <% if (UserPermissionChecker.checkParmit("/Payroll/UI/Post.aspx", "DELETER") == true)
                                       { %>
                                    <asp:ImageButton ID="imgbtnPDelete" runat="server" CommandName="Delete" Height="20px" ImageUrl="~/Images/Delete.png" OnClientClick="return confMSG()" TabIndex="16" ToolTip="Delete" Width="20px" />
                                    <% } %>
                                </ItemTemplate>
                                <HeaderStyle Width="4%" />
                                <ItemStyle Width="4%" />
