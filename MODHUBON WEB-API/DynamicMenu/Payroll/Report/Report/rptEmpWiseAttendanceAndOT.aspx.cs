...
{
    public partial class rptEmpWiseAttendanceAndOT : System.Web.UI.Page
    {
        ...
        private void gridShow()
        {
            ...
            WHERE TRANSDT BETWEEN '{frdt}' AND '{todt}' {empquery} ORDER BY EMPNM , A.TRANSDT", conn);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string BRANCHNM = DataBinder.Eval(e.Row.DataItem, "BRANCHNM").ToString();
