<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptEmpWiseAttendanceAndOT.aspx.cs" Inherits="DynamicMenu.Payroll.Report.Report.rptEmpWiseAttendanceAndOT" %>
<!DOCTYPE html>
        ...
        <div style="margin: 0 auto; padding: 10px; width: 842px;">
            ...
            <div style="height: 1104px">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" 
                    Font-Size="9pt" OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated">
                    <Columns>
