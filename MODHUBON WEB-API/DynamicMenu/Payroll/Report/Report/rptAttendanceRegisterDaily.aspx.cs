...
{
    public partial class rptAttendanceRegisterDaily : System.Web.UI.Page
    {
        ...
        private void gridShow()
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand(@"SELECT EMPTP, A.EMPID, EMPNM,  CONVERT(varchar(15),CAST(TIMEFR AS TIME),100) TIMEFR, 
            CONVERT(varchar(15),CAST(TIMETO AS TIME),100) TIMETO, 
			CASE WHEN CONVERT(varchar(15),CAST(TIMEIN AS TIME),100)='12:00AM' THEN '' ELSE CONVERT(varchar(15),CAST(TIMEIN AS TIME),100) END AS TIMEIN, 
            CASE WHEN CONVERT(varchar(15),CAST(TIMEOUT AS TIME),100)='12:00AM' THEN '' ELSE CONVERT(varchar(15),CAST(TIMEOUT AS TIME),100) END AS TIMEOUT,TRANSDT
