...
{
    public partial class OverTimeStatementDaily : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                const string formLink = "/Payroll/Report/UI/OverTimeStatementDaily.aspx";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this,
                   GetType(), "OpenWindow", "window.open('../Report/rptOverTimeStatementDaily.aspx','_newtab');", true);
