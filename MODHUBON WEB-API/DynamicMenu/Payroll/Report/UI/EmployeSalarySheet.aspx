<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="EmployeSalarySheet.aspx.cs" Inherits="DynamicMenu.Payroll.Report.UI.EmployeSalarySheet" %>
        ...
        <div id="contentBox">
            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlDepartment" runat="server" TabIndex="2" CssClass="form-control input-sm">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-4"></div>
                </div>
