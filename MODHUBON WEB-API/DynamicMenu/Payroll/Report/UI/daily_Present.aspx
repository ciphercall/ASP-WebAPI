<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="daily_Present.aspx.cs" Inherits="DynamicMenu.Payroll.UI.daily_Present" %>
        ...
        <div id="contentBox">
            ...
            <div class="form-class">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h4 class="text-center">Daily Present</h4>
                        <hr />
                        ...
                        <div class="row form-class">
                            <div class="col-md-4"></div>
                            <div class="col-md-4"> 
                                <asp:Button runat="server" ID="btnAttProcess" Text="Submit" CssClass="form-control input-sm btn-primary" OnClick="btnAttProcess_OnClick" />
