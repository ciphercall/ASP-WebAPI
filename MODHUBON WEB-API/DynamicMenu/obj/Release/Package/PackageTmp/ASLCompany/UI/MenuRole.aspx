            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox runat="server" ID="txtComapnyAdminName" CssClass="form-control input-sm" TabIndex="2"
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList runat="server" ID="ddlModuleName" TabIndex="3" CssClass="form-control input-sm text-capitalize"
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList runat="server" ID="ddlMenuType" CssClass="form-control input-sm" TabIndex="4">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <asp:Button runat="server" ID="btnSubmit" TabIndex="5" Text="Submit" CssClass="form-control input-sm btn-primary" OnClick="btnSubmit_Click"></asp:Button>
                    </div>
                        ...
                        <div class="panel-body" id="panelbody">
                            <div class="table table-responsive" style="border: 1px solid #ddd; border-radius: 5px;">
                                <asp:GridView ID="gridViewAslRole" runat="server" AutoGenerateColumns="False" BackColor="White" GridLines="Both"
                                    BorderStyle="None" CellPadding="4" CssClass="Gridview text-center" AllowPaging="True" PageSize="8" OnSorting="gridViewAslRole_Sorting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Module Name">
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtModuleName" TabIndex="11" runat="server" MaxLength="100" CssClass="form-control  input-sm" Font-Names="Calibri" />
                                            </FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Menu Name">
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtMenuName" TabIndex="12" runat="server" MaxLength="100" CssClass="form-control  input-sm" Font-Names="Calibri" />
                                            </FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Status">
                                            ...
                                            <EditItemTemplate>
                                                <asp:DropDownList runat="server" ID="ddlStatusEdit" TabIndex="21" CssClass="form-control input-sm">
                                                    <asp:ListItem Value="A">ACTIVE</asp:ListItem>
                                                    <asp:ListItem Value="I">INACTIVE</asp:ListItem>
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtStatus" TabIndex="13" runat="server"  MaxLength="100" CssClass="form-control  input-sm" Font-Names="Calibri" />
                                            </FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Insert">
                                            ...
                                            <EditItemTemplate>
                                                <asp:DropDownList runat="server" ID="ddlInsertEdit" TabIndex="22" CssClass="form-control input-sm">
                                                    <asp:ListItem Value="A">ACTIVE</asp:ListItem>
                                                    <asp:ListItem Value="I">INACTIVE</asp:ListItem>
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtUpdate" TabIndex="14" runat="server" MaxLength="100" CssClass="form-control  input-sm" Font-Names="Calibri" />
                                            </FooterTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="12%" />
                                            <ItemStyle HorizontalAlign="Center" Width="12%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Update">
                                            ...
                                            <EditItemTemplate>
                                                <asp:DropDownList runat="server" ID="ddlUpdateEdit" TabIndex="23" CssClass="form-control input-sm">
                                                    <asp:ListItem Value="A">ACTIVE</asp:ListItem>
                                                    <asp:ListItem Value="I">INACTIVE</asp:ListItem>
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            ...
                                            <EditItemTemplate>
                                                <asp:DropDownList runat="server" ID="ddlDeleteEdit" TabIndex="24" CssClass="form-control input-sm">
                                                    <asp:ListItem Value="A">ACTIVE</asp:ListItem>
                                                    <asp:ListItem Value="I">INACTIVE</asp:ListItem>
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtDelete" runat="server" TabIndex="15" MaxLength="100" CssClass="form-control  input-sm" Font-Names="Calibri" />
                                            </FooterTemplate>
                                            <HeaderStyle HorizontalAlign="Center" Width="12%" />
                                            <ItemStyle HorizontalAlign="Center" Width="12%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnedit" runat="server" CommandName="Edit" Height="20px" ImageUrl="~/Images/Edit.png" OnClientClick="confMSG()" TabIndex="110" ToolTip="Edit" Width="20px" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
