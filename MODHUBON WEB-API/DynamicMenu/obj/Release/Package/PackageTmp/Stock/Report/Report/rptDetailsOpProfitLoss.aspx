<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptDetailsOpProfitLoss.aspx.cs" Inherits="DynamicMenu.Stock.Report.Report.rptDetailsOpProfitLoss" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td class="style10">
                    &nbsp;</td>
                <td class="style9">
                    <strong>Detailed Operating Profit & Loss
                    </strong></td>
                <td class="style13">
                    &nbsp;</td>
                <td style="text-align: right" class="style14">
            ...
            <div class="showHeader" style = "width:96%; margin: 1% 2% 0% 2%;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Sale Price">
                        <HeaderStyle HorizontalAlign="Center" Width="8%" />
                        <ItemStyle HorizontalAlign="Right" Width="8%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Avg. Cost Price">
                        <HeaderStyle HorizontalAlign="Center" Width="8%" />
                        <ItemStyle HorizontalAlign="Right" Width="8%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Operating P/L">
                        <HeaderStyle HorizontalAlign="Center" Width="8%" />
                        <ItemStyle HorizontalAlign="Right" Width="8%" />
                        </asp:BoundField>
                    </Columns>
                    ...
                    <RowStyle Font-Size="13px" Font-Names="Calibri" />
                </asp:GridView>
