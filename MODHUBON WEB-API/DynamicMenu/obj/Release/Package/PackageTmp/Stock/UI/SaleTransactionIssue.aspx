<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="SaleTransactionIssue.aspx.cs" Inherits="DynamicMenu.Stock.UI.SaleTransactionIssue" %>
                ...
                <div id="contentBox">
                    <div id="">
                        <ul class="nav nav-tabs nav-justified">
                            <li role="presentation" class="grayBackground"><a href="/Stock/UI/SaleTransactionPurchase.aspx">Purchase</a></li>
                            <li role="presentation" class="active"><a href="/Stock/UI/SaleTransactionIssue.aspx">Transfer/Issue</a></li>
                        </ul>
                    </div>
                    <!-- content header end -->
                    ...
                    <div class="form-class">
                        ...
                        <div class="row form-class3px">
                            <div class="col-md-2">Issue From :</div>
                            <div class="col-md-4">
                                <asp:DropDownList runat="server" AutoPostBack="True" TabIndex="1" ID="ddlIssueFrom" CssClass="form-control input-sm" OnSelectedIndexChanged="ddlIssueFrom_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        ...
                        <div class="row form-class3px">
                            <div class="col-md-2">Issue To :</div>
                            <div class="col-md-4">
                                <%-- <asp:DropDownList runat="server" TabIndex="4" ID="ddlReceiveFrom" CssClass="form-control input-sm"></asp:DropDownList>--%>
                                <asp:DropDownList runat="server" AutoPostBack="True" TabIndex="1" ID="ddlIssueTo" CssClass="form-control input-sm"></asp:DropDownList>
                            </div>
                        ...
                        <asp:GridView ID="gv_Receive" runat="server" BackColor="White" BorderStyle="None" CssClass="Gridview text-center" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Rate">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtRateEdit_R" runat="server" ReadOnly="True" Style="text-align: right" TabIndex="21"
