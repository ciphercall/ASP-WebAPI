<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="HoliDaysType.aspx.cs" Inherits="DynamicMenu.Payroll.UI.HoliDaysType" %>
    ...
    <div class="col-md-10 pull-right" id="mainContentBox">
        <div id="contentBox">
            <div id="contentHeaderBox">
                <h1>Holiday Type Information</h1>
                ...
                <div class="btn-group pull-right" id="editOption">
                    ...
                    <ul class="dropdown-menu pull-right" style="" role="menu">
                        <% if (UserPermissionChecker.checkParmit("/Payroll/UI/HoliDaysType.aspx", "INSERTR") == true)
                           { %>
                        <li><a href="#"><i class="fa fa-plus"></i>Create</a>
                        </li>
                        <% } %>
                        <% if (UserPermissionChecker.checkParmit("/Payroll/UI/HoliDaysType.aspx", "UPDATER") == true)
                           { %>
                        <li><a href="#"><i class="fa fa-edit"></i>Update</a>
                        </li>
                        <% } %>
                        <% if (UserPermissionChecker.checkParmit("/Payroll/UI/HoliDaysType.aspx", "DELETER") == true)
                           { %>
            ...
            <asp:Label ID="lblHDAYTPID" runat="server" Visible="False"></asp:Label>

            <!-- Content Start From here -->
            <div class="form-class">
                <div class="row"></div>
               <div class="table table-responsive table-hover" style="border: 1px solid #ddd; border-radius: 5px;">
                <asp:GridView ID="gv_HDAYTP" runat="server" BackColor="White" BorderStyle="None" CssClass="Gridview text-center" CellPadding="3"
                    CellSpacing="1" GridLines="Both" AutoGenerateColumns="False" ShowFooter="True" Font-Italic="False" Width="100%"
                     OnRowCommand="gv_HDAYTP_RowCommand" OnRowDataBound="gv_HDAYTP_RowDataBound" OnRowCancelingEdit="gv_HDAYTP_RowCancelingEdit" 
                    OnRowDeleting="gv_HDAYTP_RowDeleting" OnRowEditing="gv_HDAYTP_RowEditing" OnRowUpdating="gv_HDAYTP_RowUpdating">
                    <Columns>
                        <asp:TemplateField HeaderText="ID">
                            <ItemTemplate>
                                <asp:Label ID="lblHDAYTPID" runat="server" Text='<%# Eval("HDAYID") %>'></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Holiday Name">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtHDAYTPNMEdit" runat="server" TabIndex="10" CssClass="form-control" Text='<%# Eval("HDAYNM") %>' Width="100%"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblHDAYTPNM" runat="server" Text='<%# Eval("HDAYNM") %>'></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox ID="txtHDAYTPNMFooter" TabIndex="1" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                            </FooterTemplate>
