<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="AttendanceRegisterDaily.aspx.cs" Inherits="DynamicMenu.Payroll.Report.UI.AttendanceRegisterDaily" %>
    ...
    <div class="col-md-10 pull-right" id="mainContentBox">
        <div id="contentBox">
            <div id="contentHeaderBox">
                <h1>ATTENDANCE REGISTER - DAILY</h1>
            </div>
            <!-- content header end -->
