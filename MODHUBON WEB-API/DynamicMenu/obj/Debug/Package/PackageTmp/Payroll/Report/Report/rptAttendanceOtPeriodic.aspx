<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptAttendanceOtPeriodic.aspx.cs" Inherits="DynamicMenu.Payroll.Report.Report.rptAttendanceOtPeriodic" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div style="margin: 0 auto; padding: 10px; width: 842px;">
            ...
            <div style="height: 1104px">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" Font-Size="9pt"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Date" Visible="False">
                        ...
                        <asp:BoundField HeaderText="Day" Visible="False">
