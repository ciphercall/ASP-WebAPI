<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="AttendanceOtRegisterEmployeeWise.aspx.cs" Inherits="DynamicMenu.Payroll.Report.UI.AttendanceOtRegisterEmployeeWise" %>
    ...
    <div class="col-md-10 pull-right" id="mainContentBox">
        <div id="contentBox">
            <div id="contentHeaderBox">
                <h1>ATTENDANCE & OT REGISTER - EMPLOYEE</h1>
            </div>
            <!-- content header end -->
            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlBranch" runat="server" TabIndex="1"
                            CssClass="form-control input-sm" AutoPostBack="True" OnTextChanged="ddlBranch_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlEmployee" runat="server" TabIndex="2" CssClass="form-control input-sm">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-4"></div>
                </div>
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnSubmit" runat="server" Text="Search" TabIndex="5" CssClass="btn-primary form-control input-sm" OnClick="btnSubmit_Click" />
                    </div>
                    <div class="col-md-5"></div>
                </div>
