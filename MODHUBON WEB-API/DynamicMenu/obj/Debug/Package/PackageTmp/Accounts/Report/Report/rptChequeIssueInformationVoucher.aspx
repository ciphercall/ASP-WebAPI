<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptChequeIssueInformationVoucher.aspx.cs" Inherits="DynamicMenu.Accounts.Report.Report.rptChequeIssueInformationVoucher" %>
                                ...
                                <table class="auto-style6">
                                    ...
                                    <tr>
                                        <td colspan="3" style="font-weight: 700; font-size: 18px; text-align: center; border: 2px solid #000">
                                            <asp:Label ID="lblVtype" runat="server" Style="font-family: Calibri">CHEQUE ISSUE VOUCHER</asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <table style="width: 100%; font-size: 12px; font-family: Calibri">
                                <tr>
                                    ...
                                    <td style="width: 24%; text-align: left">
                                        <asp:Label ID="lblReceiveCrBy" runat="server">Issue To</asp:Label>
                                    </td>
                                    <td style="text-align: center"><strong>:</strong></td>
                                    <td style="width: 75%; text-align: left">
                                        <asp:Label ID="lblissueto" runat="server" CssClass="style52"></asp:Label>
                                ...
                                <tr style="display: none">
                                  ...
                                  <tr>
                                    <td style="text-align: left" class="auto-style12">
                                        <asp:Label ID="Label2" runat="server">Issue From</asp:Label>
                                    </td>
                                    <td style="text-align: center" class="auto-style13"><strong>:</strong></td>
                                    <td style="text-align: left" class="auto-style14">
                                        <asp:Label ID="lblissuefrm" runat="server" CssClass="style52"></asp:Label>
                            ...
                            <table style="width: 100%; font-size: 12px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="lblunm" runat="server" Style="display: none"></asp:Label>
                                        <asp:Label ID="lbldt" runat="server" Style="display: none"></asp:Label>
                                </tr>
                            </table>
                        </td>
                    </tr>
