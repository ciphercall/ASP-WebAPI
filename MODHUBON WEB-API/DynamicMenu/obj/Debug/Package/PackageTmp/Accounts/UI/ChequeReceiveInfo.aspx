<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="ChequeReceiveInfo.aspx.cs" Inherits="DynamicMenu.Accounts.UI.ChequeReceiveInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function GetReceiveChequeNO() {
            $("[id*=txtChequeNo],[id*=txtChequeNoEdit]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "../../search.asmx/GetReceiveChequeNO",
                        type: "POST",
                        dataType: "json",
            ...
            <div class="col-md-10 pull-right" id="mainContentBox">
                <div id="contentBox">
                    <div id="contentHeaderBox">
                        <h1>CHEQUE RECEIVE INFORMATION</h1>
                    ...
                    <div class="form-class">
                        <div class="row form-class3px">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:TextBox ID="txtBankNm" runat="server" AutoPostBack="False" CssClass="form-control input-sm"></asp:TextBox>
                            ...
                            <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False" ShowFooter="True" BackColor="White" GridLines="Both"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Mode">
                                        ...
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddlTransMode" runat="server" Width="98%" CssClass="form-control input-sm" TabIndex="13">
                                                <asp:ListItem>CASH CHEQUE</asp:ListItem>
                                                <asp:ListItem>A/C PAYEE CHEQUE</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <asp:TemplateField HeaderText="Receive From">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtCreditCDEdit" runat="server" TabIndex="34" CssClass="form-control input-sm" Style="text-align: center; display: none" Text='<%# Eval("CREDITCD") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterStyle CssClass="txtalign" HorizontalAlign="Center" />
                                    ...
                                    <asp:TemplateField>
                                        <EditItemTemplate>
                                            <% if (UserPermissionChecker.checkParmit("/ACCOUNTS/UI/ChequeReceiveInfo.aspx", "UPDATER"))
                                                { %>
                                        ...
                                        <FooterTemplate>
                                            <% if (UserPermissionChecker.checkParmit("/ACCOUNTS/UI/ChequeReceiveInfo.aspx", "INSERTR"))
                                                { %>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <% } %>
                                            <% if (UserPermissionChecker.checkParmit("/ACCOUNTS/UI/ChequeReceiveInfo.aspx", "DELETER"))
                                                { %>
                                            <asp:ImageButton ID="imgbtnDelete" runat="server" CommandName="Delete" Height="20px"
                                                ...
                                                ToolTip="Delete" Width="21px" />
                                                   <asp:ImageButton ID="ImagebtnPPrint" runat="server" CommandName="Print" CssClass="txtColor" Height="20px"
                                                      CommandArgument="<%#((GridViewRow)Container).RowIndex%>"  ImageUrl="~/Images/print.png" TabIndex="24" ToolTip="Save &amp; Print" ValidationGroup="validaiton" Width="20px" />
                                            <% } %>
                                        </ItemTemplate>
