<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="SalesStatementCategoryWise.aspx.cs" Inherits="DynamicMenu.Stock.Report.UI.SalesStatementCategoryWise" %>
        ...
        <div id="contentBox">
            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                         <asp:DropDownList runat="server" ID="ddlType" TabIndex="1" CssClass="form-control input-sm">
                    <asp:ListItem Value="">--SELECT--</asp:ListItem>
                    <asp:ListItem Value="BUY">PURCHASE</asp:ListItem>
                    <asp:ListItem Value="SALE">SALES</asp:ListItem>
                    <asp:ListItem Value="IRTS">SALES RETURN</asp:ListItem>
