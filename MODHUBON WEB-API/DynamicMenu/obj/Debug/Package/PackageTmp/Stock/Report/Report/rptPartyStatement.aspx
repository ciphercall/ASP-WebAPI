<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptPartyStatement.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.Report.rptPartyStatement" %>
...
&nbsp;STATEMENT - DETAILS</strong></td>
            ...
            <div style = "width:96%; margin: 0% 2% 0% 2%; height: 1px; background: #000000;">
                ...
                <table style="width:96%; margin: 1% 2% 0% 2%; height: 1px; background: #ffffff;">
                    <tr>
                    <td>
                            <span class="style2"><strong>Party Name : </strong></span><strong>
                            <asp:Label ID="lblPartyName" runat="server" CssClass="style2"></asp:Label>
                            </strong>
                    </td>
                    </tr>
            </table>
            ...
            <div class="showHeader" style = "width:96%; margin: 1% 2% 0% 2%;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Qty (Carton)" >
