<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt-Sale-Statement-Category.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.Report.rpt_Sale_Statement_Category" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sale Statement Category</title>
            ...
            <div>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="auto-style3">&nbsp;</td>
                        <td class="auto-style1" colspan="3">
                            <strong>SALE STATEMENT CATEGORY</strong></td>
                        <td style="text-align: right">&nbsp;</td>
                        <td style="text-align: right">&nbsp;</td>
                    </tr>
                    <tr>
