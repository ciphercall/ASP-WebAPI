<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptPurchaseMemo.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.Report.rptPurchaseMemo" %>
            ...
            <div>
                <div>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="text-align: center" class="style4">&nbsp;</td>
                            <td class="style33">
                        ...
                        <tr>
                            <td class="style13"
                                style="text-align: center; font-weight: 700; font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif">&nbsp;</td>
                            <td class="style33"
                    ...
                    <asp:Label ID="lblContact" runat="server"
                        ...
                        <tr>
                            ...
                            <td class="style5"
                                ...
                                <strong>DELIVERY CHALLAN - PURCHASE</strong></td>
                            <td class="style15"
                ...
                <table style="width: 100%; margin-top: 5px; font-family: Calibri;">
                    <tr>
                        <td class="style6">&nbsp;</td>
                        <td class="style31">Date</td>
                        <td class="style8">:</td>
                        <td class="style11">
                            <asp:Label ID="lblInVDT" runat="server" CssClass="style34"></asp:Label>
                        </td>
                        <td class="style10">Invoice No <strong>:&nbsp; </strong>
                            <asp:Label ID="lblInVNo" runat="server"
                                Style="font-family: Calibri; font-size: medium"></asp:Label>
                        </td>
                        <td style="text-align: right" class="style26">&nbsp;</td>
                        <td style="text-align: right" class="style30">Sales Memo No <strong>:</strong>
                            <asp:Label ID="lblSalesMemoNo" runat="server" CssClass="style34"></asp:Label>
                            &nbsp; </td>
                    </tr>
                    <tr>
                        <td class="style6">&nbsp;</td>
                        <td class="style31">Purchase From&nbsp;</td>
                        <td class="style8">:</td>
                        <td class="style11">
                            <asp:Label ID="lblPurchaseFrom" runat="server"
                                Style="font-weight: 700;" CssClass="style34"></asp:Label>
                        </td>
                        <td class="style10">Store:
                    ...
                    <tr>
                        ...
                        <td class="style11" colspan="2">
                            <asp:Label ID="lblRemarks" runat="server" CssClass="style34"
                ...
                <div style="width: 98%; margin: 1% 1% 0% 1%;">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Bold="True" Font-Size="20px"
                    ...
                    <div style="width: 100%; font-family: Calibri;">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 5%;">
                                    <div style="width: 100%; text-align: center;">
                                        <asp:Label ID="lblTotCQTy" runat="server"
                                            Style="font-weight: bold; text-align: center;" Visible="False"></asp:Label>
                                    </div>
                                </td>
                                <td style="width: 7%;">
                                    <div style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="width: 16%;">
                                    <div style="width: 100%; text-align: right;">
                                        <asp:Label ID="lbltransportCose" runat="server" Style="font-weight: bold; text-align: right;"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td style="width: 16%;">
                                    <div style="width: 100%; text-align: right;">
                                        <asp:Label ID="lblDiscount" runat="server" Style="font-weight: bold; text-align: right;"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td style="width: 16%;">
                                    <div style="width: 100%; text-align: right;">
                                        <asp:Label ID="lblNetAmt" runat="server" Style="font-weight: bold; text-align: right;"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <table style="width: 98%; margin: 5% 1% 0% 1%; font-family: Calibri;">
                    <tr>
                        <td class="style26" style="text-align: right">&nbsp;</td>
                        <td class="style27" style="text-align: center; border-top: 1px solid #CCCCCC;">Prepared By</td>
                        <td class="style20" style="text-align: right">&nbsp;</td>
                        <td class="style28" style="text-align: center; border-top: 1px solid #CCCCCC;">Received By</td>
                        <td class="style20" style="text-align: center">&nbsp;</td>
                        <td class="style29" style="text-align: center; border-top: 1px solid #CCCCCC;">Checked By</td>
                        <td style="text-align: right" class="style20">&nbsp;</td>
                        <td style="text-align: center; border-top: 1px solid #CCCCCC;" class="style25">Authorized By</td>
