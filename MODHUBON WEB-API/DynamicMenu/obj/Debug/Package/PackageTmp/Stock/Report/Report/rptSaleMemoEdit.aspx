<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSaleMemoEdit.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.Report.rptSaleMemoEdit" %>
        ...
        <div>
            <div>
                <table style="width:100%;">
                    <tr>
                        <td style="text-align: left; font-size: 10pt; font-weight: 700" 
...
&nbsp; </td>
                    ...
                    <div style = "width:98%; margin: 1% 1% 0% 1%;"> 
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            onrowdatabound="GridView1_RowDataBound" Width="100%" ShowFooter="True" Font-Bold="True" Font-Size="20px"
                    ...
                    <table style = "width:98%; margin: 5% 1% 0% 1%;">
                       ...
                       <tr>
                            <td style="text-align: left;" colspan="9">
                                <p style="text-align: left; margin-left: 10px; font-family: Calibri;" 
                                    class="style37">
