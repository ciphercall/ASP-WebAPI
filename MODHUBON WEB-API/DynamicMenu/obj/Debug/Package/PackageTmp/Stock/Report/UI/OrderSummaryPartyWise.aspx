<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="OrderSummaryPartyWise.aspx.cs" Inherits="DynamicMenu.Stock.Report.UI.OrderSummaryPartyWise" %>
     ...
     <div class="col-md-10 pull-right" id="mainContentBox">
        <div id="contentBox">
            <div id="contentHeaderBox">
                <h1>Order Summary - Party Wise</h1>
            ...
            <div class="form-class">
                <div class="row"></div>
                 <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlPartyList" runat="server" CssClass="form-control input-sm" TabIndex="1"></asp:DropDownList>
                    </div>
