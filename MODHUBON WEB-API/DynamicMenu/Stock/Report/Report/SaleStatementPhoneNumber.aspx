<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleStatementPhoneNumber.aspx.cs" Inherits="DynamicMenu.Stock.Report.Report.SaleStatementPhoneNumber" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>:: Sale Statement By Phone Number ::</title>
   ...
   <div>
            <div style="width: 96%; margin: 0% 2% 0% 2%;">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td colspan="2"><strong>SALES STATEMENT BY MOBILE NUMBER</strong>
                        </td>
                        <td style="width: 7%;"><strong>Mobile :</strong></td>
                        <td style="width: 20%">
                ...
                <div style="width: 96%; margin: 0% 2% 0% 2%;">
                    ...
                    <asp:Repeater ID="Repeater3" runat="server" OnItemDataBound="Repeater3_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <asp:Repeater ID="Repeater4" runat="server" OnItemDataBound="Repeater4_ItemDataBound" Font-Bold="True" Font-Size="20px">
                                <ItemTemplate>
                                    <div style="border: double; border-width: 1px; border-color: black;">
                                        <span style="padding-left: 20px;">Invoice No : &nbsp; 
                                        <asp:Label runat="server" Visible="True" ID="lbldate1" Text='<%#Eval("TRANSNO") %>' Style="font-weight: bold"></asp:Label></span>
                                    ...
                                    <asp:GridView ID="gv_TransEx" runat="server" Width="100%" ShowHeader="False" ShowFooter="true" AutoGenerateColumns="False" Font-Size="11pt" Style="margin-bottom: 0px" OnRowDataBound="gv_Trans_RowDataBoundEx">
                                        <Columns>
                                            <asp:BoundField HeaderText="Item Name">
                                                <HeaderStyle Width="30%" />
                                                <ItemStyle HorizontalAlign="Left" Width="30%" />
