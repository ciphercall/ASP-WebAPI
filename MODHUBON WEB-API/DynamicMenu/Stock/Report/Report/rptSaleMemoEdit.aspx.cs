    ...
    public partial class rptSaleMemoEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dbFunctions.lblAdd(@"SELECT DISAMT FROM  STK_TRANSMST WHERE TRANSTP='SALE' AND TRANSNO = '" + InVNoEdit + "' AND STOREFR = '" + StoreID_S + "' AND TRANSDT ='" + inDate + "' AND PSID = '" + PartyID_S + "'", lblGrossDiscount);
                ...
                dbFunctions.lblAdd(@"SELECT TOTNET FROM  STK_TRANSMST WHERE TRANSTP='SALE' AND TRANSNO = '" + InVNoEdit + "' AND STOREFR = '" + StoreID_S + "' AND TRANSDT ='" + inDate + "' AND PSID = '" + PartyID_S + "'", lblNetAmount);
