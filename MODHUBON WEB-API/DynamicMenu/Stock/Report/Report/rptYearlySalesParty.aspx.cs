...
{
    public partial class rptYearlySalesParty : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblParty.Text = Session["ItemName"].ToString();
        ...
        public void showGrid()
        {
            ...
            if (Search == "Amount")
            {
                query = $@"SELECT PARTYNM, SUM(ISNULL(JANQTY,0)) JANQTY, SUM(ISNULL(FEBQTY,0)) FEBQTY, SUM(ISNULL(MARQTY,0)) MARQTY, SUM(ISNULL(APRQTY,0)) APRQTY, 
...
FROM( SELECT PSID, SUM(ISNULL(NETAMT,0)) JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-01' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, SUM(ISNULL(NETAMT,0)) FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-02' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, SUM(ISNULL(NETAMT,0)) MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-03' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, SUM(ISNULL(NETAMT,0)) APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-04' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, SUM(ISNULL(NETAMT,0)) MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-05' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, SUM(ISNULL(NETAMT,0)) JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-06' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, SUM(ISNULL(NETAMT,0)) JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-07' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, SUM(ISNULL(NETAMT,0)) AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-08' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, SUM(ISNULL(NETAMT,0)) SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-0' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, SUM(ISNULL(NETAMT,0)) OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-10' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, SUM(ISNULL(NETAMT,0)) NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-11' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, SUM(ISNULL(NETAMT,0)) DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-12' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
...
SUM(ISNULL(JANQTY,0))+SUM(ISNULL(FEBQTY,0))+SUM(ISNULL(MARQTY,0))+SUM(ISNULL(APRQTY,0))+SUM(ISNULL(MAYQTY,0))+SUM(ISNULL(JUNQTY,0))+
SUM(ISNULL(JULQTY,0))+SUM(ISNULL(AUGQTY,0))+SUM(ISNULL(SEPQTY,0))+SUM(ISNULL(OCTQTY,0))+SUM(ISNULL(NOVQTY,0))+SUM(ISNULL(DECQTY,0)) TOTQTY
FROM( SELECT PSID, SUM(ISNULL(QTY,0)) JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}-01' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, SUM(ISNULL(QTY,0)) FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--02' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, SUM(ISNULL(QTY,0)) MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--03' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, SUM(ISNULL(QTY,0)) APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--04' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, SUM(ISNULL(QTY,0)) MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--05' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, SUM(ISNULL(QTY,0)) JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--06' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, SUM(ISNULL(QTY,0)) JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--07' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, SUM(ISNULL(QTY,0)) AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--08' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, SUM(ISNULL(QTY,0)) SEPQTY, 0 OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--09' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, SUM(ISNULL(QTY,0)) OCTQTY, 0 NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--10' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, SUM(ISNULL(QTY,0)) NOVQTY, 0 DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--11' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
UNION SELECT PSID, 0 JANQTY, 0 FEBQTY, 0 MARQTY, 0 APRQTY, 0 MAYQTY, 0 JUNQTY, 0 JULQTY, 0 AUGQTY, 0 SEPQTY, 0 OCTQTY, 0 NOVQTY, SUM(ISNULL(QTY,0)) DECQTY
FROM   STK_TRANS WHERE TRANSTP = 'SALE' AND CAST(CAST(TRANSDT as DATE) as VARCHAR(7)) = '{year}--12' {Item}
AND ISNULL(QTY,0)!=0 GROUP BY PSID
) A INNER JOIN STK_PARTY B ON A.PSID = B.PARTYID
GROUP BY PARTYNM";
        ...
        protected void GridView1_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                string ItemNM = DataBinder.Eval(e.Row.DataItem, "PARTYNM").ToString();
