<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptPurchaseMemoEdit.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.Report.rptPurchaseMemoEdit" %>
...
&nbsp; </td>
                        ...
                        <tr>
                            ...
                            <td class="style8">
                                :</td>
                            <td class="style11">
                                <asp:Label ID="lblPurchaseAdd" runat="server" CssClass="style34" 
                                    Font-Names="Calibri" Font-Size="10px"></asp:Label>
                            </td>
                            <td class="style10">
                                &nbsp;</td>
                            <td class="style26">
