<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptYearlySalesItem.aspx.cs" Inherits="DynamicMenu.Stock.Report.Report.rptYearlySalesItem" %>
     ...
     <div>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="style7">&nbsp;</td>
                        <td class="style3">
                            <strong style="font-size: medium">YEARLY SALES - ITEM</strong></td>
                        <td class="style5">&nbsp;</td>
                        <td style="text-align: right">&nbsp;</td>
                        <td style="text-align: right">&nbsp;</td>
                    </tr>
