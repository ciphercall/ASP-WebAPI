<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RtpOrderSummaryCategoryyWise.aspx.cs" Inherits="DynamicMenu.Stock.Report.Report.RtpOrderSummaryCategoryyWise" %>
            ...
            <div>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="auto-style3">&nbsp;</td>
                        <td class="auto-style1" colspan="3">
                            <strong>ORDER SUMMARY - CATEGORY WISE
                    ...
                    <tr>
                       ...
                       <td style="width: 1px"><strong>:</strong></td>
                        <td class="auto-style4"><asp:Label runat="server" ID="lblCatName"></asp:Label></td>
                        <td style="text-align: right">&nbsp;</td>
                        <td style="text-align: right">&nbsp;</td>
                    </tr>
                    <tr>
                ...
                <div style="width: 96%; margin: 0% 2% 0% 2%;">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                        OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated" Width="100%">
                        <Columns>
