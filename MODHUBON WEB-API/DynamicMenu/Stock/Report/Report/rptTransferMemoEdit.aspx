<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptTransferMemoEdit.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.Report.rptTransferMemoEdit" %>
...
&nbsp; </td>
                    ...
                    <div style = "width:98%; margin: 1% 1% 0% 1%;"> 
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            onrowdatabound="GridView1_RowDataBound" Width="100%" Font-Bold="True" Font-Size="20px">
                            <Columns>
                                <asp:BoundField DataField="SL" HeaderText="SL">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="Center" Width="5%" />
                                </asp:BoundField>
                                <asp:BoundField DataField="ITEMCD" HeaderText="Barcode" >
                        ...
                        <div style="width: 100%;">
                            <table style="width: 100%;">
                                <tr>
                                    <td style = "width: 5.9%;" class="style35">
                                        <div style="width: 100%;">
                                        </div>    
                                    </td>
                                    <td style = "width: 38%;">
                                        <div style = "width: 100%;">
                                            <p style = "text-align: right; font-weight: bold;" class="style35">Total :</p>
                                        </div>
                                    </td>
                                    <td style="width: 5%;">
                                        <div style="width:100%; text-align: center;">
                                            <asp:Label ID="lblTotCQTy" runat="server" 
                                                style = "font-weight:bold; text-align:center;" CssClass="style35"></asp:Label>    
                                        </div>
                                    </td>
                                    <td style="width: 7%;">
                                        <div style="width:100%;">
                                    ...
                                    <td style="width: 7%;">
                                        <div style="width:91%; text-align:right;">
                                            <asp:Label ID="lblTotQTy" runat="server" 
                                                style="font-weight:bold; text-align:right;" CssClass="style35"></asp:Label>    
                                        </div>
                                    </td>
                                    <td style="width: 10%;">
                                        <div style="width:100%;">
