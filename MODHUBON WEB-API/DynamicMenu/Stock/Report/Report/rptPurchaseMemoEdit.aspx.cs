    ...
    public partial class rptPurchaseMemoEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dbFunctions.lblAdd(@"SELECT SUM(AMOUNT) AS AMT FROM STK_TRANSCSWHERE STK_TRANSCS.TRANSTP='IIFG' AND STK_TRANSCS.TRANSNO='" + transNo + "' AND STK_TRANSCS.TRANSDT='" + inDate + "'", lblTotAmount);
                lblInWords.Text = "";
                decimal dec;
        ...
        public void showGrid()
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand(@"SELECT ROW_NUMBER() over (order by STK_TRANSCS.TRANSSL) as SL, STK_ITEM.ITEMCD, 
