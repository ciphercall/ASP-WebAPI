<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rtp-StoreWisePurchaseDetails.aspx.cs" Inherits="DynamicMenu.Stock.Report.Report.rtp_StoreWisePurchaseDetails" %>
            ...
            <div>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="auto-style3">&nbsp;</td>
                        <td class="auto-style1" colspan="3">
                            <strong>TRANSACTION STATEMENT DETAILS : 
                    ...
                    <tr>
                     ...
                     <tr>
                       ...
                       <td style="width: 1px"><strong>:</strong></td>
                        <td class="auto-style4"><asp:Label runat="server" ID="lblStore"></asp:Label></td>
                        <td style="text-align: right">&nbsp;</td>
                        <td style="text-align: right">&nbsp;</td>
                    </tr>
                    <tr>
