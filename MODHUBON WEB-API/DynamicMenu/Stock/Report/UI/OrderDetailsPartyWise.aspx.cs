...
{
    public partial class OrderDetailsPartyWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                const string formLink = "/Stock/Report/UI/OrderDetailsPartyWise.aspx";
                ...
                if (permission)
                {
                    if (!IsPostBack)
                    {
                        ...
                        txtFrom.Text = td;
                        txtTo.Text = td;
                        dbFunctions.DropDownAddTextWithValue(ddlPartyList, "SELECT PARTYNM, PARTYID FROM STK_PARTY");
                        ddlPartyList.Focus();
                    }
                }
                else
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Page.ClientScript.RegisterStartupScript(
                    this.GetType(), "OpenWindow", "window.open('../Report/RtpOrderDetialsPartyWise.aspx','_newtab');", true);
            }
        }
    }
}