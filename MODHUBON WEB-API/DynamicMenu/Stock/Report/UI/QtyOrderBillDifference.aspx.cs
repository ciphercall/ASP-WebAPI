...
{
    public partial class QtyOrderBillDifference : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                const string formLink = "/Stock/Report/UI/QtyOrderBillDifference.aspx";
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Page.ClientScript.RegisterStartupScript(
                    this.GetType(), "OpenWindow", "window.open('../Report/rptQtyOrderBillDifference.aspx','_newtab');", true);
            }
        }
    }
}