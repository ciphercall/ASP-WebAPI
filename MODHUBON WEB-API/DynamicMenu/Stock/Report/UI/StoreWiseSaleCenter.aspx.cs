...
{
    public partial class StoreWiseSaleCenter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                const string formLink = "/Stock/Report/UI/StoreWiseSaleCenter.aspx";
                ...
                if (CheckError() == "true")
                {
                    ...
                    if (ddlSumOrDetail.Text == "DETAILS")
                        Page.ClientScript.RegisterStartupScript(
                            ...
                            "window.open('../Report/rptFactorySaleCenterDetails.aspx','_newtab');", true);
                    else
                    {
                        Page.ClientScript.RegisterStartupScript(
                            this.GetType(), "OpenWindow",
                            "window.open('../Report/rptFactoryWiseTransSummary.aspx','_newtab');", true);
