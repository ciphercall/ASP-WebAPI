<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="StoreWiseSaleCenter.aspx.cs" Inherits="DynamicMenu.Stock.Report.UI.StoreWiseSaleCenter" %>
        ...
        <div id="contentBox">
            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList runat="server" ID="ddlStoreTo" CssClass="form-control input-sm"/>
                    </div>
                    <div class="col-md-4"></div>
                </div>
                <div class="row form-class">
