...
{
    public partial class PartyWisePurchaseDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                const string formLink = "/Stock/Report/UI/PartyWisePurchaseDetails.aspx";
                ...
                if (permission == true)
                {
                    if (!IsPostBack)
                    {
                        ...
                        dbFunctions.DropDownAddTextWithValue(ddlParty, "SELECT ACCOUNTNM, ACCOUNTCD fROM GL_ACCHART WHERE SUBSTRING(ACCOUNTCD,1,7)='2020202' AND STATUSCD='P'");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (FeildCheck() == "true")
                {
                    ...
                    Session["PSID"] = ddlParty.SelectedValue;
                    Session["PartyName"] = ddlParty.SelectedItem.Text;
                    Page.ClientScript.RegisterStartupScript(
                            this.GetType(), "OpenWindow", "window.open('../Report/rpt-PartyWisePurchaseDetails.aspx','_newtab');", true);
                }
            }
        }
    }
