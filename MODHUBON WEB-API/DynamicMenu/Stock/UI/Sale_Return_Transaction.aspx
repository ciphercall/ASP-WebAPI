<%@ Page Title="" Language="C#" MasterPageFile="~/Dynamic.Master" AutoEventWireup="true" CodeBehind="Sale_Return_Transaction.aspx.cs" Inherits="DynamicMenu.Stock.UI.Sale_Return_Transaction" %>
    ...
    <script type="text/javascript">
        ...
        function BindControlEvents() {
          ...
          <%--  $("#txtBillDate").change(function () {
            ...
            $("[id*=txtnetRetFoter]").change(function () {
                var qty = $("[id*=txtQtyFooter]").val();
                var rate = $("[id*=txtnetRetFoter]").val();
                var amount = qty * rate;
                $("[id*=txtnetamntFooter]").val(amount);
                $("[id*=txtRemarksFooter]").focus();
            });
            ...
            $("[id*=txtnetretEdit]").change(function () {
                var qty = $("[id*=txtQtyEdit]").val();
                var rate = $("[id*=txtnetretEdit]").val();
                var amount = qty * rate;
                $("[id*=txtnetAmntEdit]").val(amount);
                $("[id*=txtRemarksEdit]").focus();
            });--%>
                ...
                <div id="contentBox">
                    <div id="contentHeaderBox">
                        ...
                        <div class="btn-group pull-right" id="editOption">
                            ...
                            <ul class="dropdown-menu pull-right" style="" role="menu">
                                <% if (UserPermissionChecker.checkParmit("/Stock/UI/Sale_Return_Transaction.aspx", "INSERTR"))
                                    { %>
                                <li>
                            ...
                            --%>
                            <div class="col-md-6">
                                <div align="right" class="pull-right" style="width: 50px">
                    ...
                    <div class="form-class">
                        ...
                        <div class="row form-class">
                            ...
                            <div class="col-md-2">
                                <asp:TextBox runat="server" ID="txtTransDate" AutoPostBack="True" TabIndex="1" OnTextChanged="txtTransDate_OnTextChanged" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtVehicalsNo" TabIndex="3" OnTextChanged="txtVehicalsNo_OnTextChanged" CssClass="form-control input-sm"></asp:TextBox>
                        ...
                        <div class="row form-class">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:DropDownList runat="server" ID="txtPartyName" CssClass="form-control select" TabIndex="2" AutoPostBack="True" OnSelectedIndexChanged="txtPartyName_OnSelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:TextBox runat="server" ID="txtPartyCode" Style="display: none" CssClass="form-control input-sm visible-false"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtdriverNM" OnTextChanged="txtdriverNM_OnTextChanged" TabIndex="4" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row form-class">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtRemarks" OnTextChanged="txtRemarks_OnTextChanged" TabIndex="6" CssClass="form-control input-sm"></asp:TextBox>
                            </div>

                            <div class="col-md-2">Assistant</div>
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtasstNM" OnTextChanged="txtasstNM_OnTextChanged" TabIndex="5" CssClass="form-control input-sm"></asp:TextBox>
                        ...
                        <div class="row form-class">
                            ...
                            <div class="col-md-2" align="right">
                                <asp:Button ID="btncomplete" runat="server" CssClass="form-control input-sm btn-primary" Font-Bold="True"
                                    Visible="False" OnClick="btncomplete_OnClick" Text="COMPLETE" />
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="table  table-hover" style="border: 1px solid #ddd;">
                                    <asp:GridView ID="gv_details" runat="server" AutoGenerateColumns="False" BackColor="White" GridLines="Both" ShowFooter="True"
                                        ...
                                        OnRowDataBound="gv_details_OnRowDataBound" OnRowCommand="gv_details_OnRowCommand" OnRowEditing="gv_details_OnRowEditing" OnRowCancelingEdit="gv_details_OnRowCancelingEdit"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Item Name">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:DropDownList ID="txtItemNameEdit" runat="server" AutoPostBack="True" OnSelectedIndexChanged="txtItemNameEdit_OnSelectedIndexChanged" CssClass="form-control select" Width="100%">
                                                    </asp:DropDownList>

                                                    <asp:Label runat="server" ID="lblitemidedit" TabIndex="18" Text='<%# Eval("ITEMID") %>' AutoPostBack="True" Style="display: none"></asp:Label>

                                                    <%-- <asp:DropDownList ID="txtItemNameEdit" runat="server" AppendDataBoundItems="true"  DataTextField="key" DataValueField="ITEMNM" AutoPostBack="True" SelectedValue='<%# Eval("ITEMNM") %>'></asp:DropDownList>
                                                    --%>
                                                ...
                                                <FooterTemplate>
                                                    <asp:DropDownList ID="txtItemNameFooter" runat="server" CssClass="form-control select" TabIndex="8" AutoPostBack="True" OnSelectedIndexChanged="txtItemNameFooter_OnSelectedIndexChanged" Width="100%"></asp:DropDownList>
                                            ...
                                            <asp:TemplateField HeaderText="Qty">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtQtyEdit" runat="server" AutoPostBack="True" TabIndex="19" OnTextChanged="txtQtyEdit_OnTextChanged" CssClass="form-control input-sm" Width="100%" Text='<%# Eval("QTY") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtQtyFooter" runat="server" CssClass="form-control input-sm" TabIndex="9" AutoPostBack="True" OnTextChanged="txtQtyFooter_OnTextChanged" Width="100%">0</asp:TextBox>
                                                </FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblretTp" runat="server" Text='<%# Eval("RETTP") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:DropDownList ID="ddllRetTPEdit" CssClass="form-control input-sm text-right noedit" TabIndex="20" OnTextChanged="ddllRetTPEdit_OnTextChanged" AutoPostBack="True" runat="server" Width="100%" Text='<%# Eval("RETTP") %>'>
                                                ...
                                                <FooterTemplate>
                                                    <asp:DropDownList ID="ddlRetTPFooter" CssClass="form-control input-sm text-right noedit" TabIndex="10" OnTextChanged="ddlRetTPFooter_OnTextChanged" AutoPostBack="True" runat="server" Width="100%">
                                                        <asp:ListItem>GOOD</asp:ListItem>
                                                        <asp:ListItem>BAD</asp:ListItem>
                                                    </asp:DropDownList>
                                                </FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="%">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtPerRTEdit" CssClass="form-control input-sm text-right noedit" AutoPostBack="True" OnTextChanged="txtPerRTEdit_OnTextChanged" runat="server" Width="100%" Text='<%# Eval("RETRT") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtperRTFooter" runat="server" TabIndex="11" CssClass="form-control input-sm text-right noedit" OnTextChanged="txtperRTFooter_OnTextChanged" AutoPostBack="True" Width="100%"></asp:TextBox>
                                                </FooterTemplate>
                                                <HeaderStyle HorizontalAlign="Center" Width="5%" />
                                            ...
                                            <asp:TemplateField HeaderText="Net Rate">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtnetretEdit" CssClass="form-control input-sm text-right noedit" runat="server" Width="100%" Text='<%# Eval("NETRT") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Net Amount">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtnetAmntEdit" ReadOnly="True" AutoPostBack="True" OnTextChanged="txtnetAmntEdit_OnTextChanged" CssClass="form-control input-sm text-right noedit" runat="server" Width="100%" Text='<%# Eval("NETAMT") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <FooterTemplate>
                                                    <asp:TextBox ID="txtnetamntFooter" ReadOnly="True" AutoPostBack="True" OnTextChanged="txtnetamntFooter_OnTextChanged" CssClass="form-control input-sm text-right noedit" runat="server" Width="100%"></asp:TextBox>
                                                </FooterTemplate>
                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                <ItemStyle HorizontalAlign="Right" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                                <EditItemTemplate>
                                                    <asp:ImageButton ID="imgbtnUpdate" CommandName="Update" runat="server" CssClass="" ImageUrl="~/Images/update.png"
                                                        TabIndex="22" ToolTip="Update" Height="20px" Width="20px" />
                                                ...
                                                <ItemTemplate>
                                                    <% if (UserPermissionChecker.checkParmit("/Stock/UI/Sale_Return_Transaction.aspx", "UPDATER"))
                                                        { %>
                                                    ...
                                                    <% } %>
                                                    <% if (UserPermissionChecker.checkParmit("/Stock/UI/Sale_Return_Transaction.aspx", "DELETER"))
                                                        { %>
                                                ...
                                                <FooterTemplate>
                                                    ...
                                                    <asp:ImageButton ID="ImageButton1" runat="server" CssClass="txtColor"
                                                        ImageUrl="~/Images/Checkmark.png" CommandName="Complete" ToolTip="Complete" ValidationGroup="validaiton" Width="20px" Height="20px" />
                                    ...
                                    <div class="col-md-4">
                                        <table style="width: 100%" class="table">
                                            ...
                                            <%--   <tr>
                                                ...
                                                <td style="width: 10%; text-align: center"></td>
                                                <td style="width: 40%; text-align: right">
                                                    <asp:Button runat="server" ID="btnComplete" Visible="False" Text="Complete Transaction" CssClass="form-control input-sm btn-warning" />
                                                </td>
                                            </tr>--%>
                                        </table>
                                    </div>
